...
exports.readAll = async function (req, res) {
    ...
    try {
        const respuesta = await pool.query('SELECT b.id as bid, b.descripcion as bdes, b.create_at as bcrea, t.* from bitacora as b LEFT JOIN tareas as t on (b.id_tareas = t.id) WHERE b.id_usuario = $1 order by b.create_at desc', [id]);
